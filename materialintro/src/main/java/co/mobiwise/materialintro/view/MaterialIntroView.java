...
public class MaterialIntroView extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        cancelButton = (TextView) layoutInfo.findViewById(R.id.cancel_button);
    ...
    private void setCancelButtonText(CharSequence cancelButtonText) {
    ...
    public static class Builder {
        ...
        public Builder setInfoTextTitle(CharSequence infoTextTitle) {
            materialIntroView.enableInfoDialog(true);
            materialIntroView.setTextViewInfoTitle(infoTextTitle);
            return this;
        }

        public Builder setCancelButtonText(CharSequence cancelButtonText) {
            materialIntroView.enableInfoDialog(true);
            materialIntroView.setCancelButtonText(cancelButtonText);
            return this;
        }
