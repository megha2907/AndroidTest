...
public interface ScGameService {
    ...
    Call<MatchesResponse> getMatches(@Path("userId") String userId);

    @GET("users/{userId}/questions")
    Call<QuestionsResponse> getQuestions(@Path("userId") String userId);
    ...
    Call<MyResultsResponse> getMyResults(@Path("userId") String userId,
