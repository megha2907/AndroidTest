 ...
 */
public class ChallengesFragment extends ScGameFragment implements ChallengesLayout.OnRankClickListener {

    private static final String KEY_GLOBAL_SUMMARY = "keyGlobalSummary";

    public static ChallengesFragment newInstance(GroupSummary globalSummary) {
    ...
    public void updateRank(GroupSummary groupSummary) {
        ...
        LinearLayout llMyPositionParent = (LinearLayout) findViewById(R.id.challenges_ll);
        for (Sport sport : ScGameDataHandler.getInstance().getGlbFollowedSports()) {
            ...
            llMyPositionParent.addView(new ChallengesLayout(getContext(), rankSummary, this));
        }
    }
