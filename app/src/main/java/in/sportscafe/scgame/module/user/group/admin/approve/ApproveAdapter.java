...
import in.sportscafe.scgame.Constants.NotificationKeys;
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if(null != category) {
                ...
                acceptValues.put(NotificationKeys.ADMIN_USERID, ScGameDataHandler.getInstance().getUserId());

                ScGameAnalytics.getInstance().trackOtherEvents(category, acceptValues);
            }
        }
    }
