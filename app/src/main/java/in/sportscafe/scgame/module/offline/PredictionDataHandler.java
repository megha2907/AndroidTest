package in.sportscafe.scgame.module.offline;
...
import in.sportscafe.scgame.AbstractDataHandler;
...
public class PredictionDataHandler extends AbstractDataHandler {
    ...
    public void init(Context context) {
        mNewsPreferences = context.getSharedPreferences("in.sportscafe.scgame.prediction", Context.MODE_PRIVATE);
    }
