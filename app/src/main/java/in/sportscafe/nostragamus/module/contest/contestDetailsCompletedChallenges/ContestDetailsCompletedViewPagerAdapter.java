...
public class ContestDetailsCompletedViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public ContestDetailsCompletedViewPagerAdapter(FragmentManager manager, Context context) {
        super(manager);
        mContext = context;
    }
