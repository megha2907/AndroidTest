...
public class Question {
    ...
    public void updateTotalPowerUps(MatchAnswerStats matchAnswerStats) {
        if (null != matchAnswerStats) {
            ...
            total2xPowerupsUsed = powerUpMap.get(Powerups.XX);
            totalNoNegsPowerupsUsed = powerUpMap.get(Powerups.NO_NEGATIVE);
            totalPlayerPollPowerupsUsed = powerUpMap.get(Powerups.AUDIENCE_POLL);
        }
    }
