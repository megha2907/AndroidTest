...
public class EditAnswerPredictionCardAdapter extends ArrayAdapter<EditAnswerQuestion> {

    private EditAnswerPredictionAdapterListener mAdapterListener;
    ...
    public View getView(final int position, View contentView, ViewGroup parent) {
        if (contentView != null) {
            ...
            /* Populate data on ui */
            EditAnswerQuestion question = getItem(position);
     ...
     * @param question
     */
    private void showCachedImagesOrFill(final HmImageView option1ImgView,
                                        final HmImageView option2ImgView,
    ...
    private void populateData(TextView positivePointsTextView, TextView negativePointsTextView,
                              ...
                              TextView option1TextView, TextView option2TextView,
                              EditAnswerQuestion question) {
    ...
    private void preFillIfPlayerPollAlreadyApplied(int position, TextView playerPollOption1TextView,
        ...
        /* NOTE: Same logic for EditAnswerFragment.onPlayerPollSuccess() tobe followed */
    ...
    public void applyOrRemovePowerUp(PowerUpEnum powerUpEnum, int pos, boolean shouldAdd) {
        EditAnswerQuestion question = getItem(pos);
        if (question != null) {
