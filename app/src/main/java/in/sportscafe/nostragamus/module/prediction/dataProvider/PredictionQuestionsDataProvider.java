...
public class PredictionQuestionsDataProvider {
    ...
    private void loadQuestionsFromServer(int matchId, int roomId,
        ...
        MyWebService.getInstance().getAllPredictionQuestions(matchId, roomId).enqueue(new ApiCallBack<PredictionAllQuestionResponse>() {
            @Override
            public void onResponse(Call<PredictionAllQuestionResponse> call, Response<PredictionAllQuestionResponse> response) {
