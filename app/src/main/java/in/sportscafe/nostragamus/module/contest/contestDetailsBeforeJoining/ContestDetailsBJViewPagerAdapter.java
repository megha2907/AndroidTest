...
public class ContestDetailsBJViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public ContestDetailsBJViewPagerAdapter(FragmentManager manager, Context context) {
        super(manager);
        mContext = context;
    }
