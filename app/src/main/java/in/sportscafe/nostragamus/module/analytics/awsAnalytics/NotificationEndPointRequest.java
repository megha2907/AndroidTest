...
public class NotificationEndPointRequest {

    private static NotificationEndPointRequest notificationEndPointRequest = new NotificationEndPointRequest();

    public static NotificationEndPointRequest getInstance() {
        return notificationEndPointRequest;
    }
    ...
    public void createEndpoint(final AmazonPinpointClient client, final String appId) {
        ...
        String endpointId ="";
        if (userInfo != null) {
            endpointId = String.valueOf(userInfo.getId())+"NOTIFICATION";
        }
    ...
    private EndpointRequest createEndpointRequestData() {
        ...
        if (userInfo != null) {
            ...
            String gcmDeviceToken = Nostragamus.getInstance().getServerDataManager().getGcmDeviceToken();
            Log.i("gcmtoken--",gcmDeviceToken);
            endpointRequest.withAddress(gcmDeviceToken)
