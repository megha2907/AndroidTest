package in.sportscafe.nostragamus.module.user.myprofile.myposition.challenges;
...
import in.sportscafe.nostragamus.module.user.myprofile.myposition.dto.ChallengesSummary;
import in.sportscafe.nostragamus.module.user.myprofile.myposition.dto.ChallengesTourSummary;
import in.sportscafe.nostragamus.module.user.points.PointsActivity;

/**
 * Created by Deepanshi on 13/10/16.
 */
public class ChallengesFragment extends NostragamusFragment implements ChallengesLayout.OnRankClickListener, View.OnClickListener {
