package in.sportscafe.nostragamus.utils.loadingAnim;
...
public class LoadingIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mMinWidth = a.getDimensionPixelSize(R.styleable.LoadingIndicatorView_minViewWidth, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.LoadingIndicatorView_maxViewWidth, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.LoadingIndicatorView_minViewHeight, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.LoadingIndicatorView_maxViewHeight, mMaxHeight);
