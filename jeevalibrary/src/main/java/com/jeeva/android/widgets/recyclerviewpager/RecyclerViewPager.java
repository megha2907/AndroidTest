package com.jeeva.android.widgets.recyclerviewpager;
...
import com.jeeva.android.BuildConfig;
...
public class RecyclerViewPager extends RecyclerView {
    ...
    public void setAdapter(Adapter adapter, boolean needFullView) {
        mViewPagerAdapter = ensureRecyclerViewPagerAdapter(adapter, needFullView);
        super.setAdapter(mViewPagerAdapter);
    }

    @Override
    public void swapAdapter(Adapter adapter, boolean removeAndRecycleExistingViews) {
        mViewPagerAdapter = ensureRecyclerViewPagerAdapter(adapter, true);
    ...
    @NonNull
    protected RecyclerViewPagerAdapter ensureRecyclerViewPagerAdapter(Adapter adapter, boolean needFullView) {
        return (adapter instanceof RecyclerViewPagerAdapter)
                ? (RecyclerViewPagerAdapter) adapter
                : new RecyclerViewPagerAdapter(this, adapter, needFullView);
