...
public class RecyclerViewPagerAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    private boolean mNeedFullView = true;

    public RecyclerViewPagerAdapter(RecyclerViewPager viewPager, RecyclerView.Adapter<VH> adapter, boolean needFullView) {
        mAdapter = adapter;
        mViewPager = viewPager;
        mNeedFullView = needFullView;
